...
\centering \tabletail{\hline}
\begin{supertabular}{|p{.15\textwidth}|p{.17\textwidth}|p{.17\textwidth}|p{.17\textwidth}|p{.17\textwidth}|p{.17\textwidth}|}
  \hline & Galileo & Juno & JEO & JUICE & Cassini \\ \hline Launch
  Vehicle & Space Shuttle Atlantis (STS-34R) & Atlas V551 (Atlas first
  stage with five solid rocket boosters, Centaur upper stage) & & &
  Titan IV-B/Centaur launch vehicle \\ \hline Spacecraft mass &
  Orbiter: 2,223 kg Probe: 339 kg & 3,625 kilograms total at launch,
  consisting of 1,593 kilograms of spacecraft, 1,280 kilograms of fuel
  and 752 kilograms of oxidizer & Launch Mass Capability, 5040 kg
  Launch Vehicle Adapter, 123 kg Flight System Mass, 1367 kg
  Propellant (for 2260 m/s), 2646 kg Remaining usable launch mass, 973
  kg (for contingency and system margin) & Dry mass at launch: ~1800
  kg Chemical propellant: 3000kg Payload mass: 104kg & Spacecraft Ñ
  2,442 kg Propellant Ñ 3,132 kg Total Mass Ñ 5,574 kg

  Orbiter Weight: 5,712 kilograms with fuel, Huygens probe, adapter,
  etc 2,125 kilograms unfueled orbiter alone \\ \hline Spacecraft
  dimension & Orbiter: 6.15 meters Probe: 86 cm & 3.5 meters high, 3.5
  meters in diameter & & & Orbiter dimension: 6.7 meters high; 4
  meters wide \\ \hline Power & Two Radioisotope Thermoelectric
  Generators

  Max power: 570W & Solar Arrays: length of each solar array 9 meters
  by 2.65 meters Total surface area of solar arrays: more than
  60-meters squared & 540W RPS (MMRTG or ASRG) Lithium Ion battery for
  peak power management & Power: solar panels:636-693W(EOM) Solar
  array 60 Ð 75 m2 & 885 watts (633 watts at end of mission) from
  radioisotope thermoelectric generators \\ \hline Propulsion & The
  spacecraft's propulsion module consists of twelve 10-newton
  (2.25-pound-force) thrusters and a single 400-newton
  (90-pound-force) engine which use monomethylhydrazine fuel and
  nitrogen-tetroxide oxidizer & Dual mode propulsion subsystem; a
  bi-propellant main engine and mono-propellant reaction control
  system thrusters. The 12 reaction control system thrusters allow
  translation and rotation about three axes & Bi-propellant , 900N
  gimbaled engine & High delta-V capability (2700 m/s) & Two engines,
  445 Newton thrust each \\ \hline Antenna diameter & 4.8-meter & 4
  meter & & 3m & 4m \\ \hline Total cost & \$1.3 billion & \$1.1
  billion & & & \$3.27 billion \\ \hline Additional characteristics &
  & & 3m HGA with 2-axis gimbal, 25 W X-band and Ka-band TWTAs & X-
  and Ka bands, Downlink ³ 1.4 Gbit/day & \\ \hline
\end{supertabular}
