...
\SI{3.5}{m} and a height of \SI{4}{m} as seen in figure
\ref{sketch1}. On the bottom side of the satellite, the main thruster
and the payload are attached. This is because the payload only needs
to work when the thruster is turned of. On the top side of the
satellite, the location of the communication antennae is indicated
...
\begin{figure}[H]
  \centering
  \includegraphics[angle=90,height=.95\textheight]{cylindrical}
  \caption{Cylindrical configuration}
  \label{sketch1}
\end{figure}

A next possible configuration is a cuboid with dimensions \SI{2.5}{m},
